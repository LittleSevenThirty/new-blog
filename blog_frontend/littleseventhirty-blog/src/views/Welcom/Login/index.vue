  ...
  <div style="text-align: center;margin: 0 20px">
    ...
    <div>
      <div class="other_login">
        <div>
          <el-link
            :href="env.MODE === 'development' ? env.VITE_SERVE + '/oauth/gitee/render' : env.VITE_SERVE + '/api/oauth/gitee/render'">
            <svg-icon name="gitee" width="20px" height="20px" color="#4E86F1" />
          </el-link>
        </div>
        <div style="margin-left: 1rem">
          <el-link
            :href="env.MODE === 'development' ? env.VITE_SERVE + '/oauth/github/render' : env.VITE_SERVE + '/api/oauth/github/render'">
