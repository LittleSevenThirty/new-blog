...
import { sendEmail } from "../../../apis/email/index.ts";
import { register } from "../../../apis/user/index.ts";
...
<template>
  <div style="text-align: center;margin: 0 20px">
    <div style="margin-top: 100px">
      ...
      <div style="font-size: 14px;color: grey;margin-top: 1rem">欢迎注册此学习平台，请在下方填写相关信息</div>
    </div>
