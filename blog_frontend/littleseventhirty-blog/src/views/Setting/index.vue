...
import useUserStore from "../../pinia/store/modules/user.ts";
            ...
            <div class="w-full mb-5">
              <div class="flex justify-center">
                <el-upload class="avatar-uploader" :action="uploadAvatar" :show-file-list="false"
                  ...
                  :headers="{ 'Authorization': 'Bearer ' + JSON.parse(token).token }" :auto-upload="false"
                  ref="uploadRef" name="avatarFile">
              ...
              <div class="flex justify-center">
                <el-form label-position="top" label-width="auto" class="w-full mt-5" :model="accountForm"
                  ref="baseFormRef" :rules="nicknameRules">
          ...
          <div v-if="userStore.userInfo" class="bg_card box_show rounded">
            <div style="text-align: center;padding: 15px 15px 10px 15px">
              ...
              <div style="font-size: 14px;color: grey;padding: 10px">
                {{ userStore.userInfo?.introduce || '这个用户很懒，没有填写个人简介~' }}
              </div>
            </div>
          </div>
        </transition>
