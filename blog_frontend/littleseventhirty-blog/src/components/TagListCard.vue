  ...
  <Card title="热门标签" prefix-icon="tag" :is-rotate="true" :is-scale="true" v-view-request="{ callback: loadContent }">
    <template v-slot:content>
      <div class="tag_list_container">
        ...
        <!-- 正式内容 -->
        <div v-else class="tags_wrapper">
          <!-- 装饰元素 -->
          <div class="dot1 decoration_dot"></div>
          <div class="dot2 decoration_dot"></div>
...
.tag_list_container {
  ...
  .tags_wrapper {
    ...
    &::after {
      ...
      z-index: 0;
      // 定义可视化区域-多边形-五角星
      clip-path: polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 57%, 2% 35%, 39% 35%);
    }
    ...
    .decoration_dot {
      ...
      &.dot2 {
        ...
        height: 10px;
        background-color: rgba(173, 216, 230, 0.3);
        animation: move 3.5s ease-in-out 0.2s infinite;
      }
      ...
      &.dot3 {
        ...
        animation: move 4.5s ease-in-out 0.4s infinite;
      }
      ...
      &.dot4 {
        ...
        animation: move 3s ease-in-out 0.6s infinite;
      }
    }
  }
