...
public class UserRoleController {
    ...
    public ResponseResult<List<RoleUserVO>> selectUser(
        ...
        return ResponseWrapper.handler(() -> userRoleService.selectRoleUser(roleId,username,email,0));
    }
    ...
    public ResponseResult<List<RoleUserVO>> selectNotUserByRole(
        ...
        return ResponseWrapper.handler(() -> userRoleService.selectRoleUser(roleId,username,email,1));
    }
    ...
    public ResponseResult<List<RoleAllVO>> selectPermissionIdRole(
        ...
        return ResponseWrapper.handler(() -> userRoleService.selectRoleByUserId(userId,roleName,roleKey,0));
    }
    ...
    public ResponseResult<List<RoleAllVO>> selectUserNotRole(
        ...
        return ResponseWrapper.handler(() -> userRoleService.selectRoleByUserId(userId,roleName,roleKey,1));
    }
